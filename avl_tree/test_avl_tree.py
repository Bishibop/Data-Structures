...
class AVLTreeTests(unittest.TestCase):
    ...
    def test_update_height(self):
        ...
        # This assumes that update_height is recursive
        # which would destroy the performance of the tree...
        self.tree.node.right.node.right = AVLTree(Node(8))
        # If I add the below line in, then this works.
        self.tree.node.right.update_height()
        self.tree.update_height()
